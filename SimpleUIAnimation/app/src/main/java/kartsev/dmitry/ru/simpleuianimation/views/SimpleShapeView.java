...
public class SimpleShapeView extends View {
    ...
    public static final String ANIMATION_ROTATION = "rotation";
    ...
    public SimpleShapeView(Context context, AttributeSet attrs) {
        ...
        /*switch(a.getString(R.styleable.SimpleShapeView_shape_type)) {
            case SHAPE_TRIANGLE:
                this.shapeType = 1;
                break;
            case SHAPE_CIRCLE:
        ...
        if(this.shapeSize > this.getHeight()) {
         ...
         /*switch(a.getString(R.styleable.SimpleShapeView_shape_animation)) {
             case ANIMATION_ROTATION:
                 this.shapeAnimation = 1;
                 break;
             default:
                 this.shapeAnimation = -1;
                 break;
